...
export const DishDetails: React.FC<{
  ...
  return (
    <div className="px-4 pt-2">
      <div className="shadow w-full h-[60%] bg-white grid grid-rows-3 max-h-[400px] grid-cols-2 grid-flow-col gap-4 overflow-hidden mt-5 md:mt-10 rounded-lg">
        ...
        <div className="row-span-3 col-span-1 relative mt-2 md:mt-6 mr-4">
          <h1 className="leading-5 mt-[40px] md:text-4xl font-bold md:mb-4 md:mt-[75px]">
            {currentDish.name}
          </h1>
          <div
